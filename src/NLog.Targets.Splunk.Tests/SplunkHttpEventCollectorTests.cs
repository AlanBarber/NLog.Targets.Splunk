...
namespace NLog.Targets.Splunk.Tests
{
    public class SplunkHttpEventCollectorTests
    {
        ...
        public SplunkHttpEventCollectorTests()
        {
            ...
            splunkHttpEventCollector.ServerUrl = Layout.FromString("http://localhost:8088");
            splunkHttpEventCollector.Token = Layout.FromString("bff36dda-e0fc-4cdd-b2dc-50418ee98ead");
